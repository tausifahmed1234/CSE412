...
(201, 141, 90, 2, 27000.00, 'L', 'Grey Vest', 'suit (6).png'),
(202, 142, 90, 1, 27000.00, 'L', 'Grey Vest', 'suit (6).png'),
(203, 142, 91, 1, 27500.00, 'XL', 'Black Vest', 'suit (2).png'),
(204, 143, 95, 1, 20000.00, 'L', 'Ken Vest', 'product-39.png'),
(206, 145, 90, 1, 27000.00, 'L', 'Grey Vest', 'suit (6).png');
...
(141, 'KINGSMAN876833', 59400, 2, 39, 'Thuong', 'Nguyen', '0342888525', '2002@gmail.com', '1', '', '2023-06-08', 'Cancel', 1),
(142, 'KINGSMAN80948', 59950, 2, 39, 'Thuong', 'Nguyen', '0342888525', '2002@gmail.com', '1', 'hhi', '2023-06-08', 'Ordered', 9),
(143, 'KINGSMAN728281', 22000, 2, 39, 'Thuong', 'Nguyen', '0342888525', '2002@gmail.com', '1', '', '2023-06-08', 'Pending', NULL),
(144, 'KINGSMAN7506', 29700, 2, 39, 'Thuong', 'Nguyen', '0342888525', '2002@gmail.com', '1', '', '2023-06-09', 'Pending', NULL),
(145, 'KINGSMAN216815', 29700, 2, 40, 'Thuong', 'Nguyen', '0342888525', '2002@gmail.com', '1', '', '2023-06-09', 'Pending', NULL);
...
(90, 'Grey Vest', 148, 'suit (6).png', 27000, 94, 1, '2023-06-08', 16, 1, 1, 27000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'L'),
(91, 'Black Vest', 149, 'suit (2).png', 27500, 95, 1, '2023-06-08', 16, 1, 1, 27500, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'XL'),
(92, 'Brown Vest', 273, 'product-41.png', 20000, 96, 1, '2023-06-08', 16, 1, 1, 20000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'XXL'),
(93, 'Kings Vest', 10, 'suit (3).png', 55000, 96, 1, '2023-06-08', 14, 1, 1, 55000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'M'),
(94, 'Supper Vest', 150, 'suit (5).png', 23000, 95, 1, '2023-06-08', 14, 1, 1, 27500, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'L'),
(95, 'Ken Vest', 122, 'product-39.png', 20000, 94, 1, '2023-06-08', 14, 1, 1, 20000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'L'),
(96, 'Max Vest', 123, 'product-43.png', 27000, 94, 1, '2023-06-08', 14, 1, 1, 27000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'XXL'),
(97, 'Break Vest', 123, 'suit (4).png', 27000, 94, 1, '2023-06-08', 16, 1, 1, 27000, 'A waistcoat has a full vertical opening in the front, which fastens with buttons or snaps. Both single-breasted and double-breasted waistcoats exist, regardless of the formality of dress, but single-breasted ones are more common. In a three piece suit, th', 'XXXL');
